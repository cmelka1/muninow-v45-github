...
const Residents = () => {
  ...
  const faqs = [
    {
      question: "How do I pay my municipal bills through MuniNow?",
      answer: "Simply create an account, add your address, and we'll automatically find your municipal utilities and tax bills. You can then view and pay all your bills in one place, or set up automatic payments."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes! MuniNow allows you to set up automatic payments for all your municipal bills. You can choose to pay the full amount when due or set up installment plans where available."
    }
  ];
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
                  The Easiest Way to Pay Your Municipal Bills
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground mb-8">
                  One simple dashboard for all your city services. Say goodbye to paper bills and multiple payment portals.
                </p>
