                    ...
                    {documents?.map((doc) => (
                      <div key={doc.id} className="flex items-center justify-between p-2 border rounded">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-medium text-sm truncate max-w-[180px] sm:max-w-[220px] md:max-w-[280px] lg:max-w-[340px]" title={doc.original_file_name}>{doc.original_file_name}</p>
