...
interface EditFeeProfileDialogProps {
  merchant: Merchant;
...
const EditFeeProfileDialog: React.FC<EditFeeProfileDialogProps> = ({
  merchant,
  feeProfile,
  open,
  onOpenChange,
  ...
  // Update form data when feeProfile changes
  useEffect(() => {
    if (feeProfile) {
      setFormData({
        ach_basis_points: (feeProfile.ach_basis_points || 0).toString(),
        ach_fixed_fee: (feeProfile.ach_fixed_fee || 0).toString(),
        basis_points: (feeProfile.basis_points || 0).toString(),
        fixed_fee: (feeProfile.fixed_fee || 0).toString(),
        dispute_fixed_fee: (feeProfile.dispute_fixed_fee || 0).toString(),
        dispute_inquiry_fixed_fee: (feeProfile.dispute_inquiry_fixed_fee || 0).toString(),
      });
    }
  }, [feeProfile]);
...
export default EditFeeProfileDialog;