      ...
      <ResponsiveContainer variant="section" maxWidth="4xl">
        <header className="text-center mb-10">
          ...
          <ResponsiveTypography variant="body" className="text-muted-foreground max-w-3xl mx-auto">
            Our platform connects residents and businesses to municipalities for seamless municipal services and payments.
          </ResponsiveTypography>
        </header>
        ...
        <div className={`grid md:grid-cols-3 ${isMobile ? 'gap-4' : 'gap-6'}`}>
          <Card className="bg-card overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow">
            <CardContent className={`${isMobile ? 'p-4' : 'p-5'} flex flex-col items-center text-center`}>
              ...
              <ResponsiveTypography variant="h4" className="mb-2">
                Pay All Services in One Place
              </ResponsiveTypography>
              <ResponsiveTypography variant="small" className="text-muted-foreground">
                Residents can view and pay all municipal services on a single dashboard. No more jumping between different platforms.
              </ResponsiveTypography>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow">
            <CardContent className={`${isMobile ? 'p-4' : 'p-5'} flex flex-col items-center text-center`}>
              ...
              <ResponsiveTypography variant="small" className="text-muted-foreground">
                Set up recurring payments for regular services, ensuring nothing is ever missed or late again.
              </ResponsiveTypography>
            </CardContent>
          </Card>
