-- Complete Hinsdale Customer and Profile Cleanup - Handle All FK Constraints
...
-- Step 5: Update business license applications to remove reviewer references
...
-- Step 6: Update permit applications to remove reviewer references
...
-- Step 7: Delete all merchants for Hinsdale customer
DELETE FROM public.merchants 
WHERE customer_id = 'd20b3740-65ff-4408-b8ec-8cba38a8a687';

-- Step 8: Delete Charles Melka's profile
DELETE FROM public.profiles 
WHERE customer_id = 'd20b3740-65ff-4408-b8ec-8cba38a8a687';

-- Step 9: Finally delete the Hinsdale customer record
