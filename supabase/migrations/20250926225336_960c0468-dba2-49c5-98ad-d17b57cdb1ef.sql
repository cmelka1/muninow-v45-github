-- Drop and recreate calculate_unified_service_fee function with ACH basis points fee limit
DROP FUNCTION IF EXISTS public.calculate_unified_service_fee(bigint, boolean, uuid);
