...
-- Remove the default value from status column before changing enum
ALTER TABLE municipal_service_applications ALTER COLUMN status DROP DEFAULT;
...
ALTER TABLE municipal_service_applications ALTER COLUMN status SET DEFAULT 'draft';
